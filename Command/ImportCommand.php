<?php
namespace Core\Bundle\CoreBundle\Command;

use Symfony\Component\Console\Command\Command;
use Symfony\Component\Console\Input\InputArgument;
use Symfony\Component\Console\Input\InputInterface;
use Symfony\Component\Console\Output\OutputInterface;
use Core\Bundle\CoreBundle\Form\Model\Import;
use Core\Bundle\CoreBundle\Entity\Optic;
use Core\Bundle\CoreBundle\Entity\Image;
use Core\Bundle\CoreBundle\Entity\State;
use Core\Bundle\EcommerceBundle\Entity\Category;
use Core\Bundle\EcommerceBundle\Entity\Brand;
use Core\Bundle\EcommerceBundle\Entity\BrandModel;
use Core\Bundle\EcommerceBundle\Entity\Product;
use Core\Bundle\EcommerceBundle\Entity\ProductStats;
use Core\Bundle\CoreBundle\Entity\OpticStats;
use DateTime;
...
class ImportCommand extends Command
{
    ...
    CONST DB_NAME = 'prod_optisoop6';
    CONST DB_USER = 'optisoop2';
    CONST DB_PASS = 'optisoop2';

    protected function configure()
    {
        $this
        ->setName('optisoop:import')
